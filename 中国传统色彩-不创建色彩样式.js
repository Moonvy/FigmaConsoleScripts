...
function createColor(color) {
  ...
  ins.children[0].characters = `CMYK (${color.CMYK.join(", ")})`;
  ins.children[1].characters = `RGB (${color.RGB.join(", ")})`;
  ins.children[2].characters = color.hex;
  ins.children[3].characters = color.pinyin;
  ins.children[4].characters = color.name;
  ...
  ins.children.forEach((node) => {
    if (node.type === "TEXT") {
      node.fills = [
        {
          blendMode: "NORMAL",
          color: toFloatColor(Color(fontColorContrast(color.RGB)).color),
          opacity: 1,
          type: "SOLID",
          visible: true,
        },
